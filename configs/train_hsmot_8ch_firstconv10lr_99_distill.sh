...
cd $PWD/../
EXP_DIR=/data/users/wangying01/lth/hsmot/workdir/motip_99/motip_r50_train_hsmot_8ch_distill_2gpu
...
LD_LIBRARY_PATH="" CUDA_VISIBLE_DEVICES=2,3 python3 -m torch.distributed.run --nproc_per_node=2 \
    ...
    --use-wandb False\
    --config-path /data/users/wangying01/lth/hsmot/MOTIP/configs/r50_deformable_detr_motip_hsmot8ch_99_distill.yaml \
    --outputs-dir ${EXP_DIR} \
